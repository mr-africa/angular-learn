...
class EventList {
    ...
    changeEventProperty(id: number, property: string, value: any): void {
        let updatedItem = this.feed.find(event => { return event.id === id });
